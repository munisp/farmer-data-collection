...
(1, 1, 1, 1, 'Premium Cassava Tubers - Iseyin', 'Fresh TMS 30572 cassava tubers, harvested within 48hrs. For garri, fufu, starch.', 'tubers', 5000, 'kg', 45, 225000, false, NOW() - INTERVAL '2 months', NOW() + INTERVAL '2 weeks', '["pickup","delivery"]', 'Iseyin, Oyo State', 'active', 342),
(2, 2, 3, 4, 'FARO 44 Paddy Rice - Nsukka', 'Premium long-grain paddy rice, sun-dried to 14% moisture.', 'grains', 3000, 'kg', 75, 225000, false, NOW() - INTERVAL '3 weeks', NOW() + INTERVAL '6 weeks', '["pickup","delivery"]', 'Nsukka, Enugu State', 'active', 218),
(3, 4, 5, 7, 'Shelled Groundnuts - Kano', 'Clean shelled groundnuts, SAMNUT 24. Low aflatoxin.', 'legumes', 2000, 'kg', 55, 110000, false, NOW() - INTERVAL '2 weeks', NOW() + INTERVAL '4 weeks', '["pickup","delivery"]', 'Bichi, Kano State', 'active', 156),
(4, 5, 12, 10, 'Fresh Plantain Bunches - Ondo', 'Mature Agbagba plantain, 8-12 fingers per hand.', 'fruits', 2000, 'bunches', 3500, 7000000, true, NOW() - INTERVAL '3 weeks', NOW() + INTERVAL '1 week', '["delivery"]', 'Idanre, Ondo State', 'active', 445),
(5, 6, 7, 11, 'Premium White Yam - Benue', 'Large tubers (2-5kg each), excellent pounding quality.', 'tubers', 3000, 'tubers', 800, 2400000, false, NOW() - INTERVAL '10 days', NOW() + INTERVAL '3 weeks', '["pickup","delivery"]', 'Otukpo, Benue State', 'active', 523),
(6, 3, 4, 6, 'Crude Palm Oil - Anambra', 'Fresh pressed crude palm oil, bright orange, high vitamin A.', 'oils', 200, 'litres', 1200, 240000, true, NOW() - INTERVAL '1 month', NOW() + INTERVAL '2 months', '["pickup","delivery"]', 'Awka, Anambra State', 'active', 189),
(7, 5, 6, 9, 'Fermented Cocoa Beans - Ondo', 'Grade 1 fermented cocoa beans, 7% moisture. Export quality.', 'cash_crops', 500, 'kg', 2800, 1400000, true, NOW() - INTERVAL '2 months', NOW() + INTERVAL '3 months', '["delivery"]', 'Idanre, Ondo State', 'active', 67),
(8, 7, 8, 14, 'Kebbi Premium Rice - Argungu', 'Stone-free, long-grain FARO 66 rice. Locally parboiled.', 'grains', 5000, 'kg', 72, 360000, false, NOW() - INTERVAL '1 month', NOW() + INTERVAL '2 months', '["pickup","delivery"]', 'Argungu, Kebbi State', 'active', 312),
(9, 8, 9, 15, 'Fresh Roma Tomatoes - Kaduna', 'Fresh, firm Roma VF tomatoes. Sorted and graded.', 'vegetables', 1000, 'kg', 250, 250000, false, NOW() - INTERVAL '1 week', NOW() + INTERVAL '2 weeks', '["delivery"]', 'Zaria, Kaduna State', 'active', 278),
(10, 6, 13, 13, 'Nsukka Yellow Pepper - Benue', 'Aromatic dried and ground. Very spicy. 1kg bags.', 'spices', 500, 'kg', 3500, 1750000, true, NOW() - INTERVAL '2 months', NOW() + INTERVAL '4 months', '["pickup","delivery"]', 'Otukpo, Benue State', 'active', 145),
(11, 10, 11, 18, 'Pearl Millet - Sokoto', 'Clean pearl millet, SOSAT-C88. For fura, tuwo, flour.', 'grains', 3000, 'kg', 22, 66000, false, NOW() - INTERVAL '2 weeks', NOW() + INTERVAL '6 weeks', '["pickup"]', 'Sokoto, Sokoto State', 'active', 89),
(12, 9, 10, 17, 'Organic Palm Kernel Oil - Imo', 'Cold-pressed palm kernel oil, 100% organic.', 'oils', 300, 'litres', 1800, 540000, true, NOW() - INTERVAL '3 weeks', NOW() + INTERVAL '2 months', '["delivery"]', 'Owerri, Imo State', 'active', 102);
