#!/usr/bin/env python3
"""
Create all user journey tables using individual SQL statements
This script outputs the SQL statements to be executed via webdev_execute_sql
"""
